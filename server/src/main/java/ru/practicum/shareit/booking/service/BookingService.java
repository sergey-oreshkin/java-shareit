...
public interface BookingService {
    ...
    List<Booking> getAllByBooker(Long userId, State state, Integer from, Integer size);

    List<Booking> getAllByItemsOwner(Long userId, State state, Integer from, Integer size);
}
